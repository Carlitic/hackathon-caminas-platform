-- =====================================================
-- MIGRATION: Add ENUMs and Complete RLS Policies (FIXED)
-- =====================================================

-- =====================================================
-- 0. DROP EXISTING POLICIES THAT DEPEND ON COLUMNS
-- =====================================================
...
DROP COLUMN IF EXISTS cycle CASCADE,
DROP COLUMN IF EXISTS year_level CASCADE,
...
-- SELECT: Public can see all teams (for ranking)
